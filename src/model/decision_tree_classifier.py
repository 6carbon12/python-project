...
with open('reports/accuracy_dtc.txt', 'w') as f:
...
plt.savefig('reports/confusion_matrix_dtc.png')
print("Confusion Matrix saved to 'reports/confusion_matrix_dtc.png'")

# Save the model to disk so it can be loaded later
dump(model, 'models/model_dtc.pkl')
print("Model saved to models/model_dtc.pkl")
